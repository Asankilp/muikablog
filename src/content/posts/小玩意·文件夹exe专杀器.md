...
description: 被学校的拉跨系统里的文件夹exe坑过后，就制作了本工具
tags: [Python]
category: 小玩意
draft: false
abbrlink: 22061
---
仓库地址：[WhitemuTeam/Folder-exe-virus-killer: 文件夹exe专杀器（针对某高中的拉跨系统制作） (github.com)](https://github.com/Moemu/Folder-exe-virus-killer)
...
邮箱：[master@muspace.top](mailto:master@muspace.top)
